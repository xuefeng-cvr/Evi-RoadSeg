...
def main(params):
    ...
    train_set = R2DAugmentationFusionSegmentation(args, root=args.data, split='training')
    val_set = R2DAugmentationFusionSegmentation(args, root=args.data, split='validation')
