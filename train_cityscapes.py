...
def train(args, model, optimizer, dataloader_train, dataloader_val):
    ...
    for epoch in range(args.current_epoch, args.num_epochs):
        ...
        if epoch % args.validation_step == 0:
            ...
            writer.add_scalar('epoch/global_acc', globalacc, epoch)
            ...
            writer.add_scalar('epoch/iou', iou, epoch)
...
def main(params):
    ...
    train_set = CityscapesAugmentationFusionSegmentation(args, root=args.data, split='train')
    val_set = CityscapesAugmentationFusionSegmentation(args, root=args.data, split='val')
...
if __name__ == '__main__':
    params = [
        ...
        '--num_epochs', '150',
        '--learning_rate', '1e-3',
        '--data', '/data/Cityscapes/Road',
        '--cityscapes_path', '/data/Cityscapes/Road',
        '--num_workers', '8',
        '--num_classes', '2',
        '--cuda', '0',
        '--batch_size', '8',
        '--save_model_path', './weight/cityscapes',
