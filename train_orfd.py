...
def main(params):
    ...
    train_set = OrfdAugmentationFusionSegmentation(args, root=args.data, split='training')
    val_set = OrfdAugmentationFusionSegmentation(args, root=args.data, split='validation')
