...
def geometry_depth_aug(img, depth, label, cityscapes_cars, instance_bottom_depth, cityscapes_root):
    ...
    instance_id1 = np.where(instance_bottom_depth>10)
    ...
    car_image = cv2.resize(car_image, (750, 375))
    car_label = cv2.resize(car_label, (750, 375))
    ExObj_depth = cv2.resize(ExObj_depth, (750, 375))
